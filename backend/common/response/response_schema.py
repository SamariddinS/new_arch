...
class ResponseModel(BaseModel):
    """
    Generic unified return model without response data schema
...
class ResponseSchemaModel(ResponseModel, Generic[SchemaT]):
    """
    Generic unified return model with response data schema
...
class ResponseBase:
    ...
    def __response(
        *,
        ...
        """
        Request return common method

        :param res: Return info
    ...
    def fast_success(
        *,
        ...
        """
        This method was created to improve API response speed, with significant performance gains when parsing large JSON, but loses pydantic parsing and validation

        .. warning::

            When using this return method, you cannot specify the response_model parameter and arrow return type
