...
router.include_router(redis_router, prefix='/redis', tags=['Redis Monitoring'])
router.include_router(server_router, prefix='/server', tags=['Server Monitoring'])
router.include_router(token_router, prefix='/sessions', tags=['Session Monitoring'])
