...
(2048602512369516544, 'General Switch', 'sys_choose', 'System general switch: true/false', now(), null),
...
(2048602512692477952, 'Frontend Config', 'sys_frontend_config', 'Frontend parameter configuration type', now(), null),
(2048602512755392512, 'Task Strategy Type', 'task_strategy_type', 'Scheduled task strategy type', now(), null),
(2048602512818307072, 'Task Period Type', 'task_period_type', 'Scheduled task period type', now(), null),
(2048602512881221632, 'Notice Announcement', 'notice', 'Notice type', now(), null),
...
(2048602513359372288, 'sys_menu_type', 'Menu', '1', 'default', 2, 1, 'Regular menu', 2048602512432431104, now(), null),
...
(2048602513850105856, 'sys_data_rule_expression', 'Equal (==)', '0', 'success', 1, 1, 'Equal comparison expression', 2048602512616980480, now(), null),
(2048602513917214720, 'sys_data_rule_expression', 'Not Equal (!=)', '1', 'error', 2, 1, 'Not equal comparison expression', 2048602512616980480, now(), null),
...
(2048602514051432448, 'sys_data_rule_expression', 'Greater Than or Equal (>=)', '3', 'volcano', 4, 1, 'Greater than or equal comparison expression', 2048602512616980480, now(), null),
...
(2048602514168872960, 'sys_data_rule_expression', 'Less Than or Equal (<=)', '5', 'orange', 6, 1, 'Less than or equal comparison expression', 2048602512616980480, now(), null),
(2048602514231787520, 'sys_data_rule_expression', 'Contains (in)', '6', 'purple', 7, 1, 'Contains expression', 2048602512616980480, now(), null),
(2048602514303090688, 'sys_data_rule_expression', 'Not Contains (not in)', '7', 'error', 8, 1, 'Not contains expression', 2048602512616980480, now(), null),
(2048602514366005248, 'sys_frontend_config', 'No', '0', 'red', 1, 1, 'Not frontend parameter config', 2048602512692477952, now(), null),
(2048602514433114112, 'sys_frontend_config', 'Yes', '1', 'green', 2, 1, 'Is frontend parameter config', 2048602512692477952, now(), null),
(2048602514500222976, 'task_strategy_type', 'Interval', '0', 'cyan', 1, 1, 'Time interval strategy', 2048602512755392512, now(), null),
(2048602514567331840, 'task_strategy_type', 'Crontab', '1', 'purple', 2, 1, 'Time expression strategy', 2048602512755392512, now(), null),
