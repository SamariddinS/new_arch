...
class Settings(BaseSettings):
    ...
    # Data permissions
    DATA_PERMISSION_MODELS: dict[str, str] = {  # SQLA models allowed for data filtering, must be defined as module strings
        'Department': 'backend.app.admin.model.Dept',
    }
    DATA_PERMISSION_COLUMN_EXCLUDE: list[str] = [  # Exclude SQLA model columns from data filtering
        'id',
        'sort',
        'del_flag',
        'created_time',
    ...
    # .env Operation log
    OPERA_LOG_ENCRYPT_SECRET_KEY: str  # Secret key os.urandom(32), needs to be converted to str using bytes.hex() method
    ...
    OPERA_LOG_ENCRYPT_TYPE: int = 1  # 0: AES (performance overhead); 1: md5; 2: ItsDangerous; 3: no encryption, others: replace with ******
    OPERA_LOG_ENCRYPT_KEY_INCLUDE: list[str] = [  # Encrypt values of these API parameter keys
        'password',
        'old_password',
        'new_password',
        'confirm_password',
    ...
    EMAIL_CAPTCHA_EXPIRE_SECONDS: int = 60 * 3  # 3 minutes
